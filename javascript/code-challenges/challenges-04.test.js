...
const sortPeople = (arr) => {
  return arr.sort((a, b) => {
    if (b.lastName.charCodeAt(0) > a.lastName.charCodeAt(0))
      return -1;
  })
};
...
const sortPeopleBetter = (arr) => {
  return arr.sort((a, b) => {
    ...
    let SameFirstLast = (b.lastName === a.lastName && b.firstName === a.firstName);
...
const sortSchedule = (arr) => {
  ...
  return arr.sort((a,b)=>{
    ...
    {
      let ADuration = parseInt(a.end)- parseInt(a.start) ;
      let BDuration = parseInt(b.end)- parseInt(b.start) ;
